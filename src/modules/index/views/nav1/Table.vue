<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="yhzgx" label="与户主关系" width="140" sortable>
			</el-table-column>
			<el-table-column prop="nian_ling" label="年龄" width="100" sortable>
			</el-table-column>
			<el-table-column prop="csrq" label="生日" width="120" sortable>
			</el-table-column>
...
<script>
	...
	import { getPopulationListPage, removeUser, batchRemoveUser, editUser, addUser } from 'api/api';
