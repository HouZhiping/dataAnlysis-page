	...
	<el-row class="container">
		...
		<el-col :span="24" class="main">
			<aside :class="collapsed?'menu-collapsed':'menu-expanded'">
				<!--导航菜单-->
				<el-menu :default-active="$route.path" ref="menuOpened" class="el-menu-vertical-demo" @open="handleopen" @close="handleclose" @select="handleselect"
	...
	export default {
		...
		methods: {
			...
			collapse:function(){
				...
				if(!this.collapsed){
				    //修正菜单显示时，不完整的bug
                    this.$refs.menuOpened.$el.style.cssText = ""
				}
			},
			showMenu(i,status){
