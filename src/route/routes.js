...
import Family from '../modules/index/views/nav1/Family.vue'
import Population from '../modules/index/views/nav1/Population.vue'
...
import targes from '../modules/index/views/charts/echarts-targe.vue'
...
const routers = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            leaf: true,//只有一个节点
            children: [
                {path: '/targe', component: targes, name: '关系图'},
                /*{ path: '/info', component: Info, name: 'Info列表' },
                { path: '/form', component: Form, name: 'Form' },*/
            ]
        },
        ...
        },*/
        {
            ...
            leaf: true,//只有一个节点
            children: [
                {path: '/family', component: Family, name: '家庭管理'}
            ]
        },
        {
            path: '/',
            ...
            leaf: true,//只有一个节点
            children: [
                {path: '/population', component: Population, name: '人口管理'}
            ]
        },
        {
            path: '/',
